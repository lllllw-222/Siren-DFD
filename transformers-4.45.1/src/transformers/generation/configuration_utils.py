...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        # Parameters that control the generation strategy used
        self.focus_decoding = kwargs.pop("focus_decoding", False)
        self.focus_decoding_layers = kwargs.pop("focus_decoding_layers", None)
        self.focus_converter = kwargs.pop("focus_converter", None)
        ...
        # Parameters for manipulation of the model output logits
        self.base_temperature = kwargs.pop("base_temperature", 1.0)
        self.focus_relative_top = kwargs.pop("focus_relative_top", 0.1)
        self.focus_sigma = kwargs.pop("focus_sigma", 0.25)
